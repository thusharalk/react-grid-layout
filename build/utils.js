...
/*: LayoutItem*/
{
  return {
    ...
    y: layoutItem.y,
    i: layoutItem.i,
    isDelete: layoutItem.isDelete? layoutItem.isDelete : false,
    name: layoutItem.name,
    lockerId: layoutItem.id? layoutItem.id : layoutItem.lockerId? layoutItem.lockerId : '00000000-0000-0000-0000-000000000000',
    type: layoutItem.type,
    latch: layoutItem.latch? layoutItem.latch : 0,
    sizeType: layoutItem.sizeType,
    lockSysBoardId: layoutItem.lockSysBoardId? layoutItem.lockSysBoardId: 0,
